            ...
            <div className="user-address-card my-3 px-2">
                <Row className="d-flex justify-content-between pt-2">
                    <Col xs="6" className="d-flex">
                        ...
                        <div className="p-1 item-delete-edit"> محمد علي وسام</div>
                    </Col>
                ...
                <Row className="">
                    <Col xs="12" className="d-flex">
                        <div className="p-2">رقم الموبايل:</div>
                        <div className="p-1 item-delete-edit">077803199793</div>
                    </Col>
                </Row>
                <Row className="">
                    <Col xs="12" className="d-flex">
                        <div className="p-2">الايميل:</div>
                        <div className="p-1 item-delete-edit">mohammed@gmail.com</div>
                    </Col>
                </Row>
                <Row className="mt-5">
